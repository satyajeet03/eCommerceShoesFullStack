...
// import { fetchCart, removeFromCart, updateQuantityData } from '../redux/slices/cartSlice';
...
export default function CartModal({ openModal, closeModal }: ModalProps) {
  ...
  const debouncedUpdateQuantity = useCallback(debounce((productId: string, quantity: number) => {
                          ...
                          <li key={product._id} className="flex py-6">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              ...
                              <div className="flex flex-1 items-end justify-between text-sm">
                                ...
                                <div className="flex" onClick={() => handleRemoveCart(product._id)}>
                                  <button type="button" className="font-medium text-indigo-600 hover:text-indigo-500">
                                    Remove
                                  </button>
                                </div>
